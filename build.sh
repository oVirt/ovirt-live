...
wget http://kojipkgs.fedoraproject.org//packages/sanlock/2.6/7.fc18/x86_64/sanlock-2.6-7.fc18.x86_64.rpm
wget http://kojipkgs.fedoraproject.org//packages/sanlock/2.6/7.fc18/x86_64/sanlock-lib-2.6-7.fc18.x86_64.rpm
wget http://kojipkgs.fedoraproject.org//packages/sanlock/2.6/7.fc18/x86_64/sanlock-python-2.6-7.fc18.x86_64.rpm
wget http://distro.ibiblio.org/tinycorelinux/4.x/x86/release/TinyCore-current.iso
wget http://download.fedoraproject.org/pub/fedora/linux/releases/18/Live/x86_64/Fedora-18-x86_64-Live-Desktop.iso
