...
class Plugin(plugin.PluginBase):
    ...
    @plugin.event(
        ...
        condition=lambda self: (
            self._enabled and
            self.environment[oliveconst.CoreEnv.CONFIGURE]
        ),
        before=(
    ...
    def _customization(self):
        ...
        if self.environment[oliveconst.CoreEnv.SSHD_PORT] is None:
        ...
        self.environment.setdefault(
            oliveconst.CoreEnv.SSHD_PORT,
            oliveconst.CoreEnv.DEFAULT_SSH_PORT
        )
    ...
    @plugin.event(
        ...
        name=oliveconst.Stages.AIO_CONFIG_SSH,
        condition=lambda self: (
            self._enabled and
            self.environment[oliveconst.CoreEnv.CONFIGURE]
        ),
